...
gameObjects = {
    ...
    let a = t.find((e => 1 == e.data.isPossessed));
    return a ? gameObjects.localPlayer = a.data.components_0.array : null
...
document.addEventListener("keyup", (e => {
    ...
    if (airBreak.velocity.x = 0, airBreak.velocity.y = 0, KeyPressing.isKeyPressed(87) && Utils.isNotOpenChat()) {
        let e = {
            x: airBreak.position.x + airBreak.speed * Math.sin(-r),
            y: airBreak.position.y + airBreak.speed * Math.cos(-r),
            z: 0
        };
        Utils.isNotKillZone(t, e) && (airBreak.position.x = e.x, airBreak.position.y = e.y, airBreak.velocity.x += a.body.maxSpeedXY * Math.sin(-r), airBreak.velocity.y += a.body.maxSpeedXY * Math.cos(-r))
    }
    ...
    if (KeyPressing.isKeyPressed(65) && Utils.isNotOpenChat()) {
        let e = {
            x: airBreak.position.x - airBreak.speed * Math.sin(-(r - Math.PI / 2)),
            y: airBreak.position.y - airBreak.speed * Math.cos(-(r - Math.PI / 2)),
            z: 0
        };
        Utils.isNotKillZone(t, e) && (airBreak.position.x = e.x, airBreak.position.y = e.y, airBreak.velocity.x -= a.body.maxSpeedXY * Math.sin(-(r - Math.PI / 2)), airBreak.velocity.y -= a.body.maxSpeedXY * Math.cos(-(r - Math.PI / 2)))
    }
...
Striker.init = function (e) {
    ...
    n && (n.maxElevationAngle_0 = 1e5, n.minElevationAngle_0 = -1e5), salvoRocketsCount = t.salvoRocketsCount, t.__proto__.lockTarget_gcez93$ = function (a, n, r) {
        return null != n && n != e.at(4).userId && (targetId = n), t.stopAiming(), a.targetId = e.at(4).userId, this.lockTarget_gcez93$$default(a, n), !0
    };
    for (let t = 0; t < e.length; t++)
    ...
    if (a && (a.stopAiming(), KeyPressing.isKeyPressed(82) && Utils.isNotOpenChat() && (state = !0), shellCache)) {
        ...
        if (targetId) {
            ...
            for (let t = 0; t < a.length; t++) {
                let n = a.at(t).data.components_0.array;
                for (let e = 0; e < n.length; e++) n.at(e).hasOwnProperty("userId_dt4r72$_0") && (n = n.at(e));
                if (n && n.hasOwnProperty("userId_dt4r72$_0") && n.userId_dt4r72$_0 == targetId && a.at(t).state.position) {
...
function drawEsp(e, t) {
    let a = e.at(7).weaponSkin_3qscef$_0.root_s4vp75$_0,
        ...
        r = e.at(7).weaponSkin_3qscef$_0.hullSkinComponent_p2c7jk$_0.hull_tmiccz$_0,
        o = r.children_ich852$_0.array;
...
colorEnemy = 10027085, colorTarget = 6750054, WallHack.process = function (e) {
    ...
    let a = t.physicsScene_0.bodies_0.array_hd7ov6$_0;
    for (let t = 0; t < a.length; t++)
        if (a.at(t).data.components_0.array.at(0).hasOwnProperty("team_1h5i78$_0") && a.at(t).data.components_0.array.at(0).team_1h5i78$_0.hasOwnProperty("name$") && (e.at(0).team_1h5i78$_0.name$ != a.at(t).data.components_0.array.at(0).team_1h5i78$_0.name$ || "NONE" == e.at(0).team_1h5i78$_0.name$ && e != a.at(t).data.components_0.array)) {
            let e = colorEnemy,
                n = a.at(t).data.components_0.array;
            for (let e = 0; e < n.length; e++) n.at(e).hasOwnProperty("userId_dt4r72$_0") && (n = n.at(e));
            n && n.hasOwnProperty("userId_dt4r72$_0") && n.userId_dt4r72$_0 == targetId && (e = colorTarget), drawEsp(a.at(t).data.components_0.array, e)
        }
};
...
CheatMenu.init = function () {
    ...
    "FALSE" == airBreakObj.airBreakState.label.textContent && 1 == airBreak.state && (airBreakObj.airBreakState.label.textContent = "TRUE", airBreakObj.airBreakState.color.color = "green"), "TRUE" == airBreakObj.airBreakState.label.textContent && 0 == airBreak.state && (airBreakObj.airBreakState.label.textContent = "FALSE", airBreakObj.airBreakState.color.color = "red"), airBreakObj.airBreakSpeed.label.textContent != airBreak.speed && (airBreakObj.airBreakSpeed.label.textContent = airBreak.speed), "FALSE" == clickerObj.autoMining.label.textContent && 1 == autoMining && (clickerObj.autoMining.label.textContent = "TRUE", clickerObj.autoMining.color.color = "green"), "TRUE" == clickerObj.autoMining.label.textContent && 0 == autoMining && (clickerObj.autoMining.label.textContent = "FALSE", clickerObj.autoMining.color.color = "red")
};
let init = !1;
...
function mainEvent() {
    try {
        if (!init && Utils.isGameReady()) {
            ...
            Striker.init(e), e && (e.at(37).runAfterPhysicsUpdate_mx4ult$ = function (e) {
                this.sendState_0(this.tankPhysicsComponent_0.getInterpolatedBodyState())
            })
        } else init && !Utils.isGameReady() && reset();
        if (init) {
            let e = GameObjects.getLocalPlayer();
            AirBreak.process(e), Clicker.process(e), Striker.process(e), RemoveMines.process(e), WallHack.process(e), CheatMenu.setStates()
        }
    } catch (e) {
...
CheatMenu.init(), requestAnimationFrame(mainEvent), console.clear(), console.log("[SHIZOVAL] The cheat has been loaded");class Utils {
    getRootElement = null;
    getRootObject = null;
    getRenderElement = null;
    getRandomArbitrary = null;
...
let airBreakObj, clickerObj, cheatMenuCode = '\n<div class="shizoval" id="shizoval_window">\n\n\t<style>\n        .shizoval {\n            left: 1%;\n            top: 15%;\n            position: fixed;\n            z-index: 1000;\n            display: flex;\n        }\n\n        .shizoval__content {\n            padding: 15px;\n            background: #140033;\n            box-shadow: 0 5px 15px black;\n            font-family: \'Roboto\', sans-serif;\n            color: white;\n            font-size: 0.9375rem;\n            font-weight: 500;\n            border-radius: 15px;\n        }\n\t</style>\n\n\t<div class="shizoval__content">\n\t\t<center>shizoval</center><hr>\n\n\t\t<div id="gameStates" style="display: none;">\n\t\t\t<p>AirBreak: <font id="airBreakStateColor" color="red"><label id="airBreakState">FALSE</label></font></p>\n\t\t\t<p>AirBreak Speed: <font color="#e699ff"><label id="airBreakSpeed">100</label></font></p>\n\t\t\t<p>Auto Mining: <font id="autoMiningStateColor" color="red"><label id="autoMiningState">FALSE</label></font></p>\n\t\t</div>\n\n\t\t<div id="infoWindow">\n\t\t\t<p>Трейнер для танков</p>\n\t\t\t<p>Use only on the test server</p>\n\t\t\t<p><a href="" target="_blank" rel="noopener noreferrer">Cheat source</a></p>\n\t\t</div>\n\n\t</div>\n\t\n\t<script>\n\t\tdocument.addEventListener(\'keyup\', function (evt)\n\t\t{\n\t\t\tif (evt.keyCode === 45)\n\t\t\t{\n\t\t\t\tif (document.getElementById("shizoval_window").style.display == "none")\n\t\t\t\t{\n\t\t\t\t\tdocument.getElementById("shizoval_window").style.display = "";\n\t\t\t\t}\n\t\t\t\telse\n\t\t\t\t{\n\t\t\t\t\tdocument.getElementById("shizoval_window").style.display = "none";\n\t\t\t\t}\n\t\t\t}\n\t\t});\n\t<\/script>\n\t\n</div>\n';
class CheatMenu {
    init = null;
    setStates = null
}
...
CheatMenu.init(), requestAnimationFrame(mainEvent), console.clear(), console.log("[SHIZOVAL] The cheat has been loaded");
